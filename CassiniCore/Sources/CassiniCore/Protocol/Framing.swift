...
public enum RingFraming {
    ...
    /// Full control-plane opcode set (open_ring §4.1 + Cassini RE: 0x1A/0x1B/0x25
    /// factory-reset/SetAuthKey, 0x33 realtime ACM). Completing this is what stops
    /// control responses like 0x09/0x1F/0x19/0x1D being misparsed as inner records
    /// (the 0x09 misparse otherwise injects a bogus ring_time that corrupts the
    /// sync cursor).
    public static let outerOpcodes: Set<UInt8> = [
        0x06, 0x07, 0x08, 0x09, 0x0C, 0x0D, 0x0E, 0x0F,
        0x10, 0x11, 0x12, 0x13, 0x16, 0x17, 0x18, 0x19,
        0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F,
        0x24, 0x25, 0x28, 0x29, 0x2B, 0x2C, 0x2F, 0x33,
    ]
